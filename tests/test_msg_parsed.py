...
class TestMessageParser(unittest.TestCase):
    ...
    def test_messages(self):
        ...
        expect = [
            ('BTO DPW 3.7 , PT1:3.72, PT2:4.39, PT3:5.96, SL:3.01',
            {'action': 'BTO', 'Symbol': 'DPW', 'Qty': None, 'price': 3.7, 'asset': 'stock', 'risk': None,'open_trailingstop': False,
            ...
            {'action': 'BTO', 'Symbol': 'AAPL_072123C190', 'Qty': 1, 'price': 3.0, 'asset': 'option','open_trailingstop': False,
            ...
            {'action': 'BTO', 'Symbol': 'TSLA_072123C190', 'Qty': 1, 'price': 3.0, 'asset': 'option','open_trailingstop': False,
            'strike': '190C', 'expDate': '07/21', 'risk': None, 'avg': None, 'PT1': '85%TS10%', 'PT2': None,
            'PT3': None, 'SL': '50%', 'n_PTs': 1, 'PTs_Qty': [1]}),
            ...
            {'action': 'BTO', 'Symbol': 'CHSN', 'Qty': 200, 'price': 2.57, 'asset': 'stock', 'risk': 'high','open_trailingstop': False,
            'avg': None, 'PT1': None, 'PT2': None, 'PT3': None, 'SL': None, 'n_PTs': 0, 'PTs_Qty': [1]}),
            ('BTO 1 COIN 73c 04/06 1.03 ',
            {'action': 'BTO', 'Symbol': 'COIN_040623C73', 'Qty': 1, 'price': 1.03, 'asset': 'option','open_trailingstop': False,
            ...
            {'action': 'BTO', 'Symbol': 'DPW', 'Qty': 1, 'price': 3.7, 'asset': 'stock', 'risk': None,'open_trailingstop': False,
            ...
            {'action': 'BTO', 'Symbol': 'TSLA_071423C282.5', 'Qty': 10, 'price': 0.96, 'asset': 'option','open_trailingstop': False,
            ...
            {'action': 'BTO', 'Symbol': 'SPY_032023C393', 'Qty': 2, 'price': 1.3, 'asset': 'option','open_trailingstop': False,
